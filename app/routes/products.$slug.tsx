        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="animate-fade-in">
            {images.length > 0 ? (
              ...
              <div className="aspect-square bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-3xl flex items-center justify-center shadow-large">
          ...
          <div className="animate-fade-in-up" style={{animationDelay: '0.1s'}}>
            ...
            <div className="mb-8">
              <div className="flex items-center space-x-3">
                ...
                {!isOutOfStock && (
                  <span className="text-sm text-neutral-600">Ready to ship in 24 hours</span>
                )}
              </div>
            </div>
            ...
            <Form method="post" className="space-y-8">
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center bg-neutral-100 rounded-2xl">
                    ...
                    <input
                      ...
                      min="1"
                      className="w-20 text-center py-4 text-lg font-bold bg-transparent border-none focus:outline-none text-neutral-900"
                    />
                    <button
                      type="button"
                  ...
                  <span className="text-neutral-600">Available: <span className="font-semibold text-neutral-900">{selectedVariant?.stockLevel}</span></span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <button
                  type="button"
                  className="w-full bg-white text-neutral-900 py-4 px-6 text-lg font-semibold rounded-2xl border-2 border-neutral-300 hover:bg-neutral-900 hover:text-white hover:border-neutral-900 transition-all duration-300 shadow-soft hover:shadow-medium flex items-center justify-center space-x-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
